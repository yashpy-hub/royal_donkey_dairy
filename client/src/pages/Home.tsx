...
export default function Home() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-amber-50 via-white to-green-50 pt-12 pb-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Left Content */}
            <div className="space-y-8 order-2 lg:order-1">
              <div className="space-y-4">
                <div className="inline-block px-4 py-2 bg-amber-100 text-amber-800 rounded-full text-sm font-sans font-medium">
                ...
                <p className="text-xl text-gray-700 font-serif leading-relaxed max-w-lg">
                  Discover the heritage of Royal Donkey Dairy—where centuries of
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="p-8 border border-amber-100 rounded-xl hover:shadow-lg transition-shadow bg-gradient-to-br from-amber-50 to-white">
            ...
            {/* Feature 2 */}
            <div className="p-8 border border-green-100 rounded-xl hover:shadow-lg transition-shadow bg-gradient-to-br from-green-50 to-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={idx}
                className="p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-amber-200/30 text-center hover:bg-white/20 transition-colors"
              >
