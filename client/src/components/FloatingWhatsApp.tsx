...
export default function FloatingWhatsApp() {
  ...
  const whatsappMessage = "Hello! I'm interested in Rudra Dairy & Farm's donkey milk and powder products.";
    ...
    <>
      ...
      >
        ...
        <div className="relative flex items-center justify-center w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 dark:from-green-600 dark:to-green-700 rounded-full shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-110">
          <MessageCircle className="w-8 h-8 text-white animate-bounce" style={{ animationDuration: "1.5s" }} />
        </div>

        {/* Tooltip on Hover */}
        {isHovered && (
          <div className="absolute bottom-20 right-0 bg-gray-900 dark:bg-gray-800 text-white px-4 py-2 rounded-lg shadow-lg whitespace-nowrap text-sm font-sans animate-slide-in-up" style={{ animationDuration: "0.2s" }}>
            Chat with us!
